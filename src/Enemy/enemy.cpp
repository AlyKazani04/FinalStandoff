...
Enemy::Enemy() : currentFrame(0), currentAnimation(IDLE), 
...
void Enemy::update(float deltaTime, const std::vector<sf::FloatRect>& mapRects, sf::FloatRect target)
{
...
void Enemy::setAnimation(AnimationState animation)
{
...
float Enemy::getDistancetoTarget(sf::Vector2f target)
{
...
sf::Vector2f Enemy::avoidWalls(const sf::Vector2f& directionToTarget, const std::vector<sf::FloatRect>& mapRects)
{
...
sf::Vector2f Enemy::getDirectiontoTarget(sf::Vector2f target)
{
...
std::vector<sf::IntRect>& Enemy::getCurrentAnimationFrames()
{
...
sf::Texture& Enemy::getCurrentTexture()
{
    switch (currentAnimation) {
