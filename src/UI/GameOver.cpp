...
GameOver::GameOver(sf::RenderWindow& window) : gameOverText(font), coinsText(font), buttonText(font), 
...
bool GameOver::update(sf::RenderWindow& window)
{
...
void GameOver::saveCoins(int val)
{
    coins += val;
    coinsText.setString("Coins: " + std::to_string(coins));
