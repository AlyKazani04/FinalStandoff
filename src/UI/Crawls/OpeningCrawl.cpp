#include "OpeningCrawl.hpp"

OpeningCrawl::OpeningCrawl(sf::RenderWindow& window) : window(window), text(font)
{
    clock.start();
    // Initialize font
...
bool OpeningCrawl::update(float deltaTime)
{
